            ...
            <main class="site-content">
                ...
                <div class="container-fluid">
                    <div class="row site-content-row">
                        <div class="col-sm-6 site-content-col1">
                            <div class="basket">
                                <div class="basket-table">
                                    <div class="custom-basket-table clearfix">
                                        <div class="custom-basket-table-head">
                                            <div class="col-sm-12">
                                                <div class="custom-basket-table-tr row">
                                                    ...
                                                    <div class="custom-basket-table-th col-sm-1">X</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="custom-basket-table-body clearfix ">
                                            <div class="col-sm-12">
                                                <div class="custom-basket-table-tr row">
                                                    <div class="custom-basket-table-td col-md-4 custom-basket-table-td-title">Mastava</div>
                                                    <div class="custom-basket-table-td col-md-2">2</div>
                                                    <div class="custom-basket-table-td col-md-2">4000</div>
                                                    <div class="custom-basket-table-td col-md-3">8000</div>
                                                    <div class="custom-basket-table-td custom-basket-table-td-action col-md-1"><a href="#" class="btn btn-default text-center">–</a></div>
                                                </div>
                                ...
                                <section class="buttons">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 text-center">
                                            <a href="#" class="btn btn-lg btn-default"><i class="fa fa-lg fa-trash"></i> <span class="hidden-sm hidden-xs hidden-md">Отмена</span></a>
                                        </div><!-- col -->
                                        <div class="col-sm-3 text-center">
                                            <a href="#" class="btn btn-lg btn-warning"><i class="fa fa-lg fa-save"></i> <span class="hidden-sm hidden-xs hidden-md">Сохранить</span></a>
                                        </div>
                                        <div class="col-sm-3 text-center">
                                            <a href="#" class="btn btn-lg btn-info"><i class="fa fa-lg fa-arrow-circle-up"></i> <span class="hidden-sm hidden-xs hidden-md">Вызвать</span></a>
                                        </div>
                                        <div class="col-sm-3 text-center">
                                            <a href="#" class="btn btn-lg btn-success" data-toggle="modal" data-target="#stepTwoModal"><i class="fa fa-lg fa-money" aria-hidden="true"></i> <span class="hidden-sm hidden-xs hidden-md">Оплатить</span></a>
                                        </div>
                                    </div><!-- row -->
                                </section><!-- buttons -->
                            </div>
